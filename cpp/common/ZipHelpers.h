...
template <typename T>
static inline std::optional<T> ReadFileInZipToContainer(zip_file_t* file, u32 chunk_size = 16384)
{
...
static inline std::optional<std::string> ReadFileInZipToString(zip_file_t* file, u32 chunk_size = 16384)
{
...
static inline std::optional<std::vector<u8>> ReadBinaryFileInZip(zip_file_t* file, u32 chunk_size = 16384)
{
